...
namespace WebAuctions.Persistence.SqlPersistence
{
    public class AuctionSqlPersistence : IAuctionPersistence
    {
        ...
        public AuctionSqlPersistence(UnitOfWork unitOfWork)
        {
        ...
        public List<Auction> GetUsersOngoingAuctions(string username, DateTime now)
        {
            ...
            foreach (AuctionDB act in auctionDbs)
            {
                var auction = new Auction(
                    act.Id,
                    act.Auctioneer,
                    new Item(act.Item.Picture, act.Item.Name, act.Item.Description),
                act.ExpirationDate,
                    act.Date,
        ...
        public List<Auction> GetUsersWonAuctions(string username, DateTime now)
        {
            ...
            var result = auctions
                ...
                .Select(auctionDB => new Auction(
                    ...
                    new Item(auctionDB.Item.Picture, auctionDB.Item.Name, auctionDB.Item.Description),
        ...
        {
            var auctions = _unitOfWork.AuctionRepository.Get(includeProperties: "Bids,Item");
        ...
        {
            var auctionDb = _unitOfWork.AuctionRepository.Get(filter: a => a.Id == id, null, "Bids,Item").FirstOrDefault();
        ...
        public List<Auction> GetAuctionsByName(string userName)
        {
            ...
            foreach (var auctionDb in auctions)
            {
                Item item = new Item(auctionDb.Item.Picture, auctionDb.Item.Name, auctionDb.Item.Description);
